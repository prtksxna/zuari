...
function zuari_scripts() {
	...
	wp_enqueue_style( 'zuari-google-fonts', 'https://fonts.googleapis.com/css?family=IBM+Plex+Mono:400,700|IBM+Plex+Sans+Condensed:400,700|IBM+Plex+Serif:300i,400,400i,700|IBM+Plex+Sans:100,300i,400,700&display=fallback', false );
