...
if ( ! function_exists( 'zuari_setup' ) ) :
	...
	function zuari_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'zuari' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'zuari_custom_background_args', array(
...
function zuari_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'zuari' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'zuari' ),
...
function zuari_scripts() {
	...
	wp_enqueue_script( 'zuari-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );
